...
* TODO Metodologia                                                 :noexport:
** Configuração Experimental: Máquinas
  #+BEGIN_center
  #+ATTR_LaTeX: :height 0.45\textwidth :center
  [[./../img/machines.png]]
  #+END_center
** Configuração Experimental: Software
  #+BEGIN_center
  #+ATTR_LaTeX: :height 0.45\textwidth :center
  [[./../img/software.png]]
  #+END_center

** Configuração Experimental: Parâmetros da Aplicação
- Tamanho da matriz: 8192
- Tamanho do bloco: [32, 64, 128, 256, 512]
...
>>>>>>> cb6755e0a17fdee133a508e6f587b2c9d57b7a01
** Referências
#+latex: \nocite{*}
