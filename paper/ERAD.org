...
citadas no editor Emacs \cite{stallman2017emacs} permitiu o uso quase natural de
blocos de código de análise dos dados em R entrelaçados com notas sobre esses.
...
1]].Listamos em cada uma dessas o seu identificador, o(s) processador(es), a
