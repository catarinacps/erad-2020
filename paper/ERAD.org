...
| KStar_StarPU    | Diretivas | StarPU  (LWS scheduler) | @@latex:\texttt{master}$_{bf6af54e57bad130}$@@ |
| LIBKOMP_libgomp |           | OpenMP/LIBKOMP-LLVM     | @@latex:\texttt{master}$_{32781b6dab10b1b5}$@@ |
| LIBKOMP_libomp  |           | OpenMP/LIBKOMP-GCC      | @@latex:\texttt{master}$_{32781b6dab10b1b5}$@@ |
|-----------------+-----------+-------------------------+------------------------------------------------|
