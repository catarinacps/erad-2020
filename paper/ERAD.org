...
#+author: Lucas Mello Schnorr @@latex: \vspace{-0.5cm}@@
...
aqui avaliados, definimos como fatores do projeto experimental o tamanho da
...
através de blocos de códigos embutidos em arquivos Org \cite{dominik2010orgmode}
versionados na ferramenta =git=. Assim, construímos um caderno de laboratório
