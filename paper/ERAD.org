...
dessas nas versões LIBKOMP e KStar_StarPU. A versão StarPU manteve boa
...
que ambos LIBKOMP_clang quanto KStar_StarPU apresentam uma ociosidade média
consideravelmente maior. Em todos os casos, libgomp_GCC, libomp_LLVM e StarPU
...
Fora as implementações KStar_StarPU e StarPU, todas essas tarefas foram
iniciadas no primeiro segundo de execução. Além disso, a implementação
KStar_StarPU iniciou essas tarefas significativamente antes do que a em StarPU
nativo.
...
libgomp_GCC, libomp_LLVM e LIBKOMP. Além disso, verificamos que as ferramentas
...
ferramenta KStar_StarPU em quase todos os casos, o que acreditamos indicar que
