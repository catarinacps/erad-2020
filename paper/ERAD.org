...
biblioteca StarPU utilizada foi a versão estável =1.3.1=. Para todos os binários
...
\cite{broquedis2012libkomp} e KStar \cite{7912335}, foram utilizadas as versões
em desenvolvimento, /branch/ =libkomp=, /commit hash/ =32781b6dab10b1b5= e
/branch/ =master=, /commit hash/ =bf6af54e57bad130=.
