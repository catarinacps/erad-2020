...
Interfaces/ (APIs) para utilizar a fim de utilizar efetivamente o paralelismo
...
do LLVM, o /runtime/ da biblioteca LIBKOMP baseado em X-Kaapi e também através
da transpilação para StarPU realizada pelo compilador KStar. A implementação em
StarPU, por fim, será executada nativamente. Sendo assim, nossos objetivos nesse
trabalho são comparar o *escalonamento* das tarefas, observar a *ociosidade* dos
