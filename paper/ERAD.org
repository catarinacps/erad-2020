...
O trabalho aborda a comparação entre runtimes OpenMP
...
Comentários:
- sec 1: "nós" se refere a quem? autores ? precisam reescrever a 1a frase.
...
- sec 2: qual é o algoritmo base da fatoração QR com tarefas ? Acredito que os autores não
