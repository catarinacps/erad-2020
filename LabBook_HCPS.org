...
**** Plots
 #+begin_src R :results output graphics :file img/trace-qr-starpu-kstar-starvz.png :exports both :width 1600 :height 1500 :session Rvz :eval no-export
state_chart(blockQrStarpuKstar[[1]])
 #+end_src

 #+RESULTS:
 [[file:img/qr-starpu-kstar-starvz.png]]
