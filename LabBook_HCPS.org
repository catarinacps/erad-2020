...
Error: unexpected ')' in:
"  read_csv(filename) %>%
    mutate(expid = exp_name, platform = unlist(strsplit(filename, "/", fixed = TRUE))[-2]))"
...
Error: Column `platform` must be length 22 (the number of rows) or one, not 5
#+end_example
...
# A tibble: 450 x 9
   node  rep_id matrix_size block_size runtime       compute_time total_time expid platform
   <
 <
      <
     <
...
<
 ...
 1 cei2       1        8192        512 libomp               107.       108.  exp01 cei
 2 cei2       1        8192         32 libkomp_clang         NA         NA   exp01 cei
 3 cei2       1        8192        256 libkomp_gcc           92.7       94.1 exp01 cei
 4 cei2       1        8192        512 starpu               107.       109.  exp01 cei
 5 cei2       1        8192        512 libkomp_clang        107.       108.  exp01 cei
 6 cei2       1        8192         64 libkomp_gcc          306.       307.  exp01 cei
 7 cei2       1        8192         64 starpu               229.       231.  exp01 cei
 8 cei2       1        8192        256 libgomp               86.7       88.2 exp01 cei
 9 cei2       1        8192         32 libomp               761.       763.  exp01 cei
10 cei2       1        8192         64 libgomp              240.       241.  exp01 cei
# … with 440 more rows
#+end_example
...
<
    <dbl>
 1 cei             8192         32 kstar_starpu      82.9           5  1.38   5625216
 2 cei             8192         32 libgomp          763.            5 40.3    5625216
 3 cei             8192         32 libkomp_clang     NA             5 NA      5625216
 4 cei             8192         32 libkomp_gcc       NA             5 NA      5625216
 5 cei             8192         32 libomp           706.            5 52.9    5625216
 6 cei             8192         32 starpu           751.            5 63.9    5625216
 7 cei             8192         64 kstar_starpu      10.5           5  1.30    707264
 8 cei             8192         64 libgomp          241.            5  7.58    707264
 9 cei             8192         64 libkomp_clang    308.            5  8.02    707264
10 cei             8192         64 libkomp_gcc      306.            5  6.39    707264
# … with 80 more rows
#+end_example
...
#+begin_src R :session :results output graphics :file (org-babel-temp-file "figure" ".png") :exports both :width 500 :height 450
...
: Warning messages:
: 1: Removed 13 rows containing missing values (geom_point).
: 2: Removed 16 rows containing missing values (geom_errorbar).
