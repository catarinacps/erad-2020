...
exp01_df %>%
  group_by(matrix_size, block_size, runtime) %>%
...
# A tibble: 30 x 7
   matrix_size block_size runtime       avg_time repetitions error num_tasks
         <
     <
<
           <
...
<
    <dbl>
 1        8192         32 kstar_starpu      82.9           5  1.38   5625216
 2        8192         32 libgomp          763.            5 40.3    5625216
 3        8192         32 libkomp_clang     NA             5 NA      5625216
 4        8192         32 libkomp_gcc       NA             5 NA      5625216
 5        8192         32 libomp           706.            5 52.9    5625216
 6        8192         32 starpu           751.            5 63.9    5625216
 7        8192         64 kstar_starpu      10.5           5  1.30    707264
 8        8192         64 libgomp          241.            5  7.58    707264
 9        8192         64 libkomp_clang    308.            5  8.02    707264
10        8192         64 libkomp_gcc      306.            5  6.39    707264
# … with 20 more rows
#+end_example
...
#+RESULTS:
[[file:/tmp/babel-FB6Yle/figurefJXc0C.png]]
